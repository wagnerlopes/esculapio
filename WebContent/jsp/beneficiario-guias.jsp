...
<tiles:putAttribute name="corpo">
  ...
  <div class="page-header">
    <h3><s:property value="beneficiario"/></h3>  
  </div>
  ...
  <table id="example" class="table table-striped">
    ...
    <tr>
      ...
      <th class="col-lg-5 text-left">OCS/PSA</th>
      <th class="col-lg-1 text-left">Protocolo</th>
    ...
    <s:iterator id="c" value="lista">
      ...
      <s:url id="recibo" action="guia" method="recibo">
        <s:param name="guia.id" value="%{id}"/>
      </s:url>
      <tr>
        <td class="text-center"><s:property value="guiaNr"/></td>
        <td class="text-left"><s:property value="ocs.descricao"/></td>
        <td class="text-left"><s:property value="protocolo"/></td>
        ...
        <td class="text-center">
          ...
          <s:a href="%{recibo}" title="Recibo" target="_blank"><span class="fa fa-file"></span></s:a>
        </td>
      </tr>
    </s:iterator>
    </tbody>
