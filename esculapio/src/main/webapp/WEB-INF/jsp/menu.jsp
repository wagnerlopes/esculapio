...
<nav class="navbar navbar-default" role="navigation">
  ...
  <script type="text/javascript" src="<c:url value='/etc/bootstrap/js/jquery-1.10.2.js'/>"></script>
  ...
  <script type="text/javascript" src="<c:url value='/etc/bootstrap/js/holder.js'/>"></script>

  <script type="text/javascript" src="/hospital/dwr/util.js"></script>
  <script type="text/javascript" src="/hospital/dwr/engine.js"></script>
  <script type="text/javascript" src="/hospital/dwr/interface/pmService.js"></script>
  <script type="text/javascript" src="/hospital/dwr/interface/ocsPmService.js"></script>
  <script type="text/javascript" src="/hospital/dwr/interface/dthService.js"></script>
  <script type="text/javascript" src="/hospital/etc/hospital.js"></script>
